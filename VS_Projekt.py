...
Tento algoritmus slúži na určenie toho, či je číslo prvočíslom.

---------------------------------------------------

Tento projekt bol vytvorený pre vzdelávacie účely.

"""


def vypocti_delitelov(cislo):
    """Funkcia na hladanie poctu delitelov zadaneho cisla."""
    pocet_delitelov = 0
    if cislo > 10:
        pocet_delitelov = 1
    for i in range(1, 10):
