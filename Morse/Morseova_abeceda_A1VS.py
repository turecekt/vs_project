...
"""
Tenhle kolekce nám umožňuje pracovat s písmeny, číslicemi a několik unikátních znaků, které pomocí funkcí lze kódovat a dekódovat.
...
def Kodovat(text):
    """
    Funkce  přiřazuje z kolekce písmen danné znaky. Do funkce je vložena podmínka v případě, kdy v textu bude
    mezera.
    """
    Ktext = ""
    for pismena in text:
...
def main():
    """Do proměnné Ktext vložíme text, který chceme kódovat, do proměnné Detext vložíme znaky Morseovy abecedy,
