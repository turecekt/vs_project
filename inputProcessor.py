...
def inputPoint(point, coordNames=["x", "y"], debug=False):
    ...
    Function support multi-dimension space based on cordNames provided.
...
def getPoints(args, debug=False):
    ...
    Coordinates are parsed from provided command line arguments
    list (args) or interactively inputed to console by user.
