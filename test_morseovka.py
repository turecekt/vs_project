...
def test_prelozit_do():
    ...
    #ověření překladače, jestli zvládne přeložit jednotlivé znaky oddělené mezerami#
    assert morseovka.prelozit_do('A H O J') == '.- | .... | --- | .--- '
    #ověření překladače, jestli zvládne přeložit symboly#
    assert morseovka.prelozit_do('/,?)(') == '-..-. --..-- ..--.. -.--.- -.--. '
    #ověření překladače, jestli zvládne přeložit různé symboly, čísla a znaky ve větě#
    assert morseovka.prelozit_do('Lo(rem 4 ipsum dolor sit amet, 6 consecte/tuer adipiscing elit? Cras el)ementum. Nulla accumsan, 5') == '.-.. --- -.--. .-. . -- | ....- | .. .--. ... ..- -- | -.. --- .-.. --- .-. | ... .. - | .- -- . - --..-- | -.... | -.-. --- -. ... . -.-. - . -..-. - ..- . .-. | .- -.. .. .--. .. ... -.-. .. -. --. | . .-.. .. - ..--.. | -.-. .-. .- ... | . .-.. -.--.- . -- . -. - ..- -- .-.-.- | -. ..- .-.. .-.. .- | .- -.-. -.-. ..- -- ... .- -. --..-- | ..... '
    #ověření překladače, jestli zvládne přeložit čísla oddělené mezerami#
    assert morseovka.prelozit_do('1 2 3 4') == '.---- | ..--- | ...-- | ....- '
  
def test_prelozit_z():
    #ověření překladače, jestli zvládne přeložit jednotlivé znaky z Morseovy abecedy#
    ...
    assert morseovka.prelozit_z('- --- -- .- ... | .... -. .- -. .. -.-. . -.-') == 'TOMAS HNANICEK'
    #ověření překladače, jestli zvládne přeložit větu#
    assert morseovka.prelozit_z('.-.. --- .-. . -- | .. .--. ... ..- -- | -.. --- .-.. --- .-. | ... .. - | .- -- . -') == 'LOREM IPSUM DOLOR SIT AMET'
