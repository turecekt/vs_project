...
class TestCases(unittest.TestCase):
    ...
    def test_PocetKazdyZnakInFile(self):        ###   test fnce ktera vypise pocet kazdeho znaku z vlozeneho file    ###
    ...
    def test_PocetKazdyZnakInText(self):        ###   test fnce ktera vypise pocet kazdeho znaku z vlozeneho textu    ###
