...
class TestCases(unittest.TestCase):
    ...
    def test_PocetZnak(self):
        """test počtu znaků ve vstupním textu, kdy povinný atribut #(hash) není brán jako znak"""
        vstup = "AAAAAAAA#"
        self.assertEqual(PocetZnak(vstup), 8)

    def test_PocetZnak(self):
        """"test počtu znaků ve vstupním souboru, kdy povinný atribut #(hash) není brán jako znak"""
        vstup = "test_file.txt"
    ...
    def test_MinZnakNoHash(self):
        """test informace o minimálním počtu znaků ve vstupním textu bez povinného atributu #(hash)"""
        vstup = ""
    ...
    def test_MinZnakNoHashinFile(self):
        """test informace o minimálním počtu znaků ve vstupním souboru bez povinného atributu #(hash)"""
        vstup = "test_file.txt"
        self.assertEqual(MinZnak(vstup),0)
