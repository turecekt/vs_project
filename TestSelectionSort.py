...
class TestSelectionSort(unittest.TestCase):
    ...
    def test_sorting_small_unsorted(self):
        """
        Check the correctness of selection sort with unsorted small array.

        :return: AssertionError if error, otherwise nothing
        """
        self.assertEqual(selection_sort([11, 15, 3, 29, 14, 39, 81, 45, 31]),
                         [3, 11, 14, 15, 29, 31, 39, 45, 81])

    def test_sorting_large_sorted(self):
        """
        Check the correctness of selection sort with sorted large array.
    ...
    def test_sorting_large_unsorted(self):
        """
        Check the correctness of selection sort with unsorted large array.
    ...
    def test_sorting_empty_array(self):
        """
        Check the correctness of insert sort with empty array.
