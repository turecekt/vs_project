...
class TestMusicPlayer(unittest.TestCase):
    """Vytvoreni classu TestMusicPlayer."""
    ...
    def test_sound_unicode(self):
        ...
        import shutil
        # Modul shutil nabizi radu operaci na vysoke urovni
        # Se soubory a sbirkami souboru
        # Konkretne jsou k dispozici funkce podporujici kopirovini
        # A mazini souboru
        ...
        # oddelovacem adresaru ( ' / ' )
        # po kazde neprazdne casti s vyjimkou komponenty posledni cesty
    ...
    def test_init__zero_values(self):
        """Kontrola vstupnich podminek zvukovych charakteristik."""
    ...
    def test_get_num_channels__defaults_eight_after_init(self):
        """Kontrola poctu vstupnych konalu."""
        # Porovnani poctu zvukovych kanalu
        # v mixer.get_num_channels() s ocekavanymi 8 kanaly.
        mixer.init()
